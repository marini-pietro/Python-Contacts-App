...
class TestMyFunction(unittest.TestCase):
    ...
    def run_all_tests(self):
        ...
        self.test_add_contact(name=input("Enter name: "), phone=input("Enter phone: "), phone_prefix=input("Enter phone prefix: "))
        self.test_delete_contact(phone_number=input("Enter phone number to delete: "))
        self.test_search_contacts(name=input("Enter name: "), phone=input("Enter phone: "), phone_prefix=input("Enter phone prefix: "))
        self.test_get_all_contacts()
        self.test_connection_close()

        print("Passed all tests.", flush=True)
    ...
    def test_add_contact(self, name:str, phone:str, phone_prefix:str):
        # Test case 3: Check if a contact is successfully added to the database
        result = utils.add_contact(name, phone, phone_prefix)
    ...
    def test_search_contacts(self, name:str, phone:str, phone_prefix:str):
        # Test case 5: Check if the search function returns a list of contacts and not an int
        result = utils.search_contacts(name, phone, phone_prefix)
